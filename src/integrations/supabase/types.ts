  ...
  public: {
    Tables: {
      account_relationships: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "account_relationships_partner_account_id_fkey"
      ...
      accounts: {
        Row: {
          ...
          gcp_ae_email: string | null
          gcp_ae_name: string | null
          id: string
          industry: string | null
          name: string
          notes: string | null
          pnh_account_id: string | null
          status: string
          tenant_id: string
          updated_at: string
          website: string | null
      ...
      ai_insights_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_insights_log_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      attribution: {
        ...
        Relationships: [
          {
            foreignKeyName: "attribution_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
      ...
      conversations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "conversations_pending_event_id_fkey"
      ...
      document_template_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "document_template_items_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      events: {
        ...
        Relationships: [
          {
            foreignKeyName: "events_confirmation_conversation_id_fkey"
            columns: ["confirmation_conversation_id"]
            isOneToOne: false
            referencedRelation: "conversations"
            referencedColumns: ["id"]
          },
      ...
      opportunities: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "opportunities_partner_account_id_fkey"
            columns: ["partner_account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
      ...
      opportunity_lines: {
        Row: {
          ...
          description: string | null
          id: string
          line_type: Database["public"]["Enums"]["opportunity_line_type"]
        ...
        Relationships: [
          {
            foreignKeyName: "opportunity_lines_opportunity_id_fkey"
      ...
      property_portal_ids: {
        ...
        Relationships: [
          {
            foreignKeyName: "property_portal_ids_property_id_fkey"
            columns: ["property_id"]
            isOneToOne: false
            referencedRelation: "properties"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "property_portal_ids_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      tenant_appointment_agent_settings: {
        Row: {
        ...
        Relationships: [
          {
            foreignKeyName: "tenant_appointment_agent_settings_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: true
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      tenant_captacion_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "tenant_captacion_settings_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: true
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      tenant_followup_settings: {
        Row: {
          after_attempts: string
          created_at: string
          custom_context: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "tenant_followup_settings_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: true
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      vendor_registration_processes: {
        Row: {
          account_id: string | null
          alta_status: Database["public"]["Enums"]["vendor_reg_status"]
          assigned_to: string | null
          compras_status: Database["public"]["Enums"]["vendor_reg_status"]
          contrato_status: Database["public"]["Enums"]["vendor_reg_status"]
          country: string
          created_at: string
          id: string
          legal_status: Database["public"]["Enums"]["vendor_reg_status"]
          notes: string | null
          opportunity_id: string | null
          seguridad_status: Database["public"]["Enums"]["vendor_reg_status"]
          tenant_id: string
          updated_at: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "vendor_registration_processes_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "vendor_registration_processes_assigned_to_fkey"
            columns: ["assigned_to"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "vendor_registration_processes_opportunity_id_fkey"
            columns: ["opportunity_id"]
            isOneToOne: false
            referencedRelation: "opportunities"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "vendor_registration_processes_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      kb_category:
        ...
        | "post_sale"
        | "objections"
      opportunity_line_type: "licencia" | "servicio" | "gcp" | "tercero"
      opportunity_stage:
        | "etapa_0_captacion"
      ...
      ticket_status:
        ...
        | "resolved"
        | "closed"
      vendor_reg_status: "pendiente" | "en_proceso" | "completado" | "bloqueado"
