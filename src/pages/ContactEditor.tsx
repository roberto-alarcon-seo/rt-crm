...
export default function ContactEditor() {
  ...
  const [formData, setFormData] = useState<B2BContactFormData>({
    ...
    // Legacy RE fields kept as null (DB columns exist, just not shown in UI)
